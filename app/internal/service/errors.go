...
import (
	...
	images_service "github.com/Falokut/image_processing_service/pkg/image_processing_service/v1/protos"
...
func (e *errorHandler) createExtendedErrorResponce(err error, DeveloperMessage, UserMessage string) error {
	...
	if len(UserMessage) > 0 {
		extErr, _ = extErr.WithDetails(&images_service.UserErrorMessage{Message: UserMessage})
		if extErr == nil {
			e.logger.Error(err)
			return err
		}
